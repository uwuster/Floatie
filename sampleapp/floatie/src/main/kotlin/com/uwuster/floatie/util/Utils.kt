...
internal fun isViewGravityLeft(gravity: DraggableWindowItemGravity): Boolean {
    return gravity == DraggableWindowItemGravity.TOP_LEFT || gravity == DraggableWindowItemGravity.BOTTOM_LEFT
}
...
internal fun isViewGravityTop(gravity: DraggableWindowItemGravity): Boolean {
    return gravity == DraggableWindowItemGravity.TOP_LEFT || gravity == DraggableWindowItemGravity.TOP_RIGHT
}
