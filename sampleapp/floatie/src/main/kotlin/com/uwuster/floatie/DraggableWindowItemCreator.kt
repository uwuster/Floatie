package com.uwuster.floatie

import android.graphics.Point
import android.view.*
import com.uwuster.floatie.util.*
import com.uwuster.floatie.util.VelocityTrackerHelper
import com.uwuster.floatie.util.getScreenWidth
import com.uwuster.floatie.util.isViewGravityLeft
            ...
            when (event.action) {
                ...
                MotionEvent.ACTION_UP -> {
                    if (lastAction == MotionEvent.ACTION_DOWN) {
                        listener?.onTouchEventChanged(view, Point(params.x, params.y), currentTouchPoint, velocityTrackerHelper.velocityX, velocityTrackerHelper.velocityY, DraggableWindowItemTouchEvent.CLICK_EVENT)
                    } else {
                        listener?.onTouchEventChanged(view, Point(params.x, params.y), currentTouchPoint, velocityTrackerHelper.velocityX, velocityTrackerHelper.velocityY, DraggableWindowItemTouchEvent.DRAG_STOP_EVENT)
                    }
                ...
                MotionEvent.ACTION_MOVE -> {
                    ...
                    listener?.onTouchEventChanged(view, Point(params.x, params.y), currentTouchPoint, velocityTrackerHelper.velocityX, velocityTrackerHelper.velocityY, DraggableWindowItemTouchEvent.DRAG_EVENT)
